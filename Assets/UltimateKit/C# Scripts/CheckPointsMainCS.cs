...
public class CheckPointsMainCS : MonoBehaviour {
	...
	*/
	...
	{	
		...
		fPathLength = ((PathLineDrawerCS)tCPsGroup.GetComponent(typeof(PathLineDrawerCS))).fPathLength;
		...
		{
			CPPositions[i] = ((PathLineDrawerCS)tCPsGroup.GetComponent(typeof(PathLineDrawerCS))).Parameterized_CPPositions[i];
	...
	*/
	...
	{		
		...
		fNextPathLength = ((PathLineDrawerCS)tNextCPsGroup.GetComponent(typeof(PathLineDrawerCS))).fPathLength;
		
		NextCPPositions = new Vector3[((PathLineDrawerCS)tNextCPsGroup.GetComponent(typeof(PathLineDrawerCS))).Parameterized_CPPositions.Length];
		for(int i=0;i<NextCPPositions.Length;i++)
		{
			NextCPPositions[i] = ( (PathLineDrawerCS)tNextCPsGroup.GetComponent(typeof(PathLineDrawerCS)) ).Parameterized_CPPositions[i];			
