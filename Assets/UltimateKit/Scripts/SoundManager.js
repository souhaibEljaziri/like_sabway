...
public function isSoundEnabled() { return bSoundEnabled; }
public function isMusicEnabled() { return bMusicEnabled; }
 ...
 * */
public function toggleScriptState(state:boolean):void
{
	this.enabled = state;
}