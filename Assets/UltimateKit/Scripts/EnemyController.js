...
function FixedUpdate ()
{
	...
	{	
		tEnemy.localEulerAngles.y = 0;//to ensure correct rotation animation
	...
	{
		fEnemyPosition = Mathf.Lerp(fEnemyPosition, fEnemyPositionX+00, Time.fixedDeltaTime*00);//vertical position after skid
		tEnemy.position.z = Mathf.Lerp(tEnemy.position.z, tPlayer.position.z + 00, Time.deltaTime*00);//horizontal position after skid
		
		tEnemy.localEulerAngles = Vector3.Lerp(tEnemy.localEulerAngles, Vector3(0,0,0), Time.deltaTime*10);//90 degree rotation
